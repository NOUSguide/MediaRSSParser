...
- (void)verifyMediaRSS_Item1
{
    ...
    [self verifyMediaRSS_Item1_UnsupportedProperties];
}
...
- (void)verifyMediaRSS_Item1_UnsupportedProperties
{
    RSSItem *item1 = testChannel.items[0];
    
    NSArray *unsupportedElementsA = item1.unsupportedElements[@"unsupportedElementA"];
    
    assertThat(unsupportedElementsA, hasCountOf(2));
    assertThat(unsupportedElementsA[0], equalTo(@"Media Item 1 Unsupported Element A 1/2"));
    assertThat(unsupportedElementsA[1], equalTo(@"Media Item 1 Unsupported Element A 2/2"));
    
    assertThat(item1.unsupportedElements[@"unsupportedElementB"], equalTo(@"Media Item 1 Unsupported Element B 1/1"));
}
